...
import { updatePaymentReport } from '../../db/services/TransactionPremiumHelper';
...
const ReportPayment = ({ navigation, route }) => {
  ...
  const handleSubmit = async () => {
    ...
    const data = JSON.stringify({
      server_error: paymentItem.error,
    ...
    await updatePaymentReport(paymentItem.id, true, data);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Text style={styles.reportTitle}>{I18n.t('report_payment_title')}</Text>
